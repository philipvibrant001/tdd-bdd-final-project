...
# =============================
    ...
    def test_update_without_id_raises_error(self):
        ...
        # ✅ Product was NEVER saved → no ID exists
    ...
    # =============================
    # Covers Line 139 (serialize)
    # =============================
    def test_serialize_product(self):
        """It should serialize a product correctly"""
        product = ProductFactory()
        product.create()
    ...
    # =====================================
    # Covers Line 145 (deserialize success)
    # =====================================
    def test_deserialize_valid_product(self):
        ...
        self.assertEqual(product.description, "Mechanical keyboard")
        self.assertEqual(product.price, Decimal("120.50"))
        self.assertTrue(product.available)
        self.assertEqual(product.category, Category.TOOLS)


    # ============================================
    # # Covers Lines 148–149 (bad boolean validation)
    # # ============================================
    def test_deserialize_invalid_available_type(self):
        ...
        data = {
            ...
            "category": "TOOLS",  # ✅ VALID category (important!)
        }
    ...
    # ============================================
    # Covers Lines 217–221 (string → Decimal price)
    # ============================================
    def test_find_by_price_with_string(self):
        ...
        results = Product.find_by_price("49.99")

        self.assertEqual(results.count(), 1)
        self.assertEqual(results.first().price, product.price)